            ...
            <div className='flex flex-col-reverse md:flex-row md:items-center justify-center gap-3 md:justify-between'>
                ...
                <div className='flex items-center gap-6 text-xs md:text-base'>
                     <div className='flex items-center gap-2'>
                         <span className='flex rounded items-center gap-1 text-white font-medium bg-green-600 px-2 py-1'>{props.restaurantRating}<TiStarFullOutline/></span>
                         <span>
                             <strong>2</strong>
