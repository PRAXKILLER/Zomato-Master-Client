...
//components
import NutritionHeroCarauselCard from './NutritionHeroCarauselCard';
import {NextArrow, PrevArrow} from '../CarouselArrows';

function NutritionHeroCarausel() {
        ...
        <div>
            <Slider {...settings}>
                {heroBanners.map((image) => (
                    <NutritionHeroCarauselCard image={image} />
                ))}
            </Slider>
        </div>
    )
...
export default NutritionHeroCarausel
